...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/06/16 01:56:29 by loamar            #+#    #+#             */
/*   Updated: 2020/06/16 02:02:33 by loamar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**  x and y must fit into the size of the window, no control is done on the
**  values
*/
...
**  usefull in a network environment where graphical app show on a remote
**  monitor that can have a different endian
*/
...
/*
** image_writable can loop forever if no flush occurred. Flush is always
** done by mlx_loop.
